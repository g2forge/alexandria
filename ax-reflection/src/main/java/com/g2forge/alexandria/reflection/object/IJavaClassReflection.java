...
public interface IJavaClassReflection<T> extends IJavaGenericTyped<T>, IJavaAnnotated, IJavaClassStructure<IJavaClassReflection<?>, IJavaFieldReflection<T, ?>, IJavaMethodReflection<T, ?>>, IJavaTypeReflection<T> {
	@Override
