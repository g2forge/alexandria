...
/**
 * Abstract implementation of {@link com.g2forge.alexandria.java.typed.ITypeRef} used to statically capture a parameterized (generic) Java type. If you the type
 * <code>T</code> is not parameterized, you may prefer {@link com.g2forge.alexandria.java.typed.ITypeRef#of(Class)} as being simpler. To use this class one
