...
import com.g2forge.alexandria.java.function.IPredicate;
...
public class TestIOptionalFunction {
	...
	public void recursive() {
		...
		final IOptionalFunction<Integer, Integer> recursivePrior = function.recursive(IPredicate.create(false), true, Integer.class);
	...
	public void recursiveNonPrior() {
		...
		final IOptionalFunction<Integer, Object> recursive = function.recursive(IPredicate.create(false), false, Integer.class);
