...
public class TestIOptionalFunction {
	...
	public void override() {
		final IOptionalFunction<Object, String> override = IOptionalFunction.of(NullableOptional.FACTORY, 0, "Zero").override(IOptionalFunction.of(NullableOptional.FACTORY, 1, "One"));
