...
public class OutputFSMTransitionBuilder<CurrentState extends IGeneric<CurrentArgument>, CurrentArgument, Event extends IGeneric<EventArgument>, EventArgument, NextState extends IGeneric<NextArgument>, NextArgument, Output> {
	...
	public IFSMTransition<CurrentState, CurrentArgument, Event, EventArgument, NextState, NextArgument, Output> build() {
		return new FSMTransition<>(getCurrent(), getEvent(), getGuard(), getNext(), getArgument(), getOutput());
	}
}