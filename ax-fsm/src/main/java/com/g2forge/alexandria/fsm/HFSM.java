...
public class HFSM {
	...
	public static <CurrentState extends IGeneric<CurrentArgument>, CurrentArgument, Event extends IGeneric<EventArgument>, EventArgument, NextState extends IGeneric<Void>> IFSMTransition<CurrentState, CurrentArgument, Event, EventArgument, NextState, Void> transition(IFSMType<CurrentState, CurrentArgument> current, IFSMType<Event, EventArgument> event, IFSMType<NextState, Void> next) {
		return new FSMTransition<>(current, event, null, next, (ca, ea) -> null);
	}
