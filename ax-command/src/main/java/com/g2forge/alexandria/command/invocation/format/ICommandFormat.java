...
/**
 * A per-command interface to describe how arguments to this command should be quoted by
 * {@link com.g2forge.alexandria.command.process.cmdline.ICommandLineBuilder}. This is per-command because while under POSIX processes are given a pre-parsed
 * command block, but the <a href="https://docs.microsoft.com/en-us/cpp/cpp/main-function-command-line-args?redirectedfrom=MSDN&view=vs-2019">Win32 API</a>
 * specifies that processes get a command line which they are at their leisure to parse any way they like.
 * 
